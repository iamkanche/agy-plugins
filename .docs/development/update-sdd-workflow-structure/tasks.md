...
- [ ] 1. Move `docs/` directory to `.docs/` and update product docs structure (`.docs/product/plugins/kanche/{domain}` -> `.docs/product/{domain}`).
...
- [ ] 3. Update all 39 existing skill `SKILL.md` files in `plugins/kanche/skills/`:
  ...
  - [ ] Update all references from `docs/` to `.docs/` and `docs/product/plugins/kanche/` to `.docs/product/`.
