...
- Existing `.sdd-docs/guidelines/{product,tech,structure,rules}.md` if present (you are
...
- Follow `.sdd-docs/guidelines/rules.md` (when refreshing) and the project's output-language policy.
