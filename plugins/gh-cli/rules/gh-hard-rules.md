...
- **Every side effect is human-gated.** Before creating a pull request, submitting review comments, approving a pull request, or replying to review threads: STOP and ask the user to confirm, showing exactly what metadata/content will be posted to GitHub. Proceed only on an explicit yes.
